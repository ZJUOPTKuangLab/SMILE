%% This is code is for processing the experiment data （tilt-SMILE）
...
load('Template data for tilt SMILE\psf\NPC_50astig_tilt_SMILE.mat')    % load cubic-spline parameters ========================================================================================
PSF = insitu_PSF;
...
file_title = 'Template data for tilt SMILE\raw\';
Last_batch = 10;
Last_round = 10;   % This means the reconstruction will end at the Last_round of Last_batch

save_path = 'Template data for tilt SMILE\'; % Remember to revise the save path ====================================================================================================================================================================================
...
close all
%--------------------------------------------------------------------------------------------------------------------------------------------------------------------%
mask_factor = 0.45;  % mask to determine the minimum estimate pattern period 

pixel = 15;  % The pixelsize of the rendered image
