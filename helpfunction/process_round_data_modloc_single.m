...
function [lpx, lpy, para_est, result_xy, result_6N, result_init, final_x, final_y, final_z, N_x, N_y, N_z, bg_x, bg_y, bg_z, frame] = process_round_data_modloc_single(tmp_image, coeff, phase_difference, x_pixelsize, z_pixelsize, boxsz, thresh_dist, thresh_low, thresh_high, ...
