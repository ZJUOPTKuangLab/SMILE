...
%%
function [subregion_ch,seg_display] = crop_subregion_ast6N(data1,boxsz,thresh,thresh_dist,setup)
...
[subregion_ch1, ~, ~]=cMakeSubregions(allcds_mask(:,2),allcds_mask(:,1),allcds_mask(:,3),boxsz, ims_ch1(:,:,:,1)); %ims_ch1
[subregion_ch2, ~, ~]=cMakeSubregions(allcds_mask(:,2),allcds_mask(:,1),allcds_mask(:,3),boxsz, ims_ch1(:,:,:,2)); %ims_ch1
[subregion_ch3, ~, ~]=cMakeSubregions(allcds_mask(:,2),allcds_mask(:,1),allcds_mask(:,3),boxsz, ims_ch1(:,:,:,3)); %ims_ch1
[subregion_ch4, ~, ~]=cMakeSubregions(allcds_mask(:,2),allcds_mask(:,1),allcds_mask(:,3),boxsz, ims_ch1(:,:,:,4)); %ims_ch1
[subregion_ch5, ~, ~]=cMakeSubregions(allcds_mask(:,2),allcds_mask(:,1),allcds_mask(:,3),boxsz, ims_ch1(:,:,:,5)); %ims_ch1
[subregion_ch6, ~, ~]=cMakeSubregions(allcds_mask(:,2),allcds_mask(:,1),allcds_mask(:,3),boxsz, ims_ch1(:,:,:,6)); %ims_ch1

[~, l1, t1]=cMakeSubregions(allcds_mask(:,2),allcds_mask(:,1),allcds_mask(:,3),boxsz, sum(ims_ch1,4)); %ims_ch1
locs = size(subregion_ch1,3);
subregion_ch = zeros(boxsz, boxsz, locs, 6);
subregion_ch(:,:,:,1) = subregion_ch1;
subregion_ch(:,:,:,2) = subregion_ch2;
subregion_ch(:,:,:,3) = subregion_ch3;
subregion_ch(:,:,:,4) = subregion_ch4;
subregion_ch(:,:,:,5) = subregion_ch5;
subregion_ch(:,:,:,6) = subregion_ch6;

%% save display
seg_display.ims_ch1 = sum(ims_ch1,4);
